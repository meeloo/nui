...
void nglInvertLine32 (unsigned int* pDst, unsigned int* pSrc, uint32 pixelcount)
{
  uint32 count = pixelcount;
  pSrc += count - 1;
  while (--count)
...
/// From 32 BPP
void nglCopyLine8To8 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  if (Invert)
  {
    int32 i;
...
void nglCopyLine8To15 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  unsigned short temp;
  char* pSource = (char*)pSrc;
...
void nglCopyLine8To16 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  unsigned short temp;
  char* pSource = (char*)pSrc;
...
void nglCopyLine8To24 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  char* pSource = (char*) pSrc;
  if (Invert)
...
void nglCopyLine8To32 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  if (Invert)
  {
    int32 i;
...
/// From 15 BPP
void nglCopyLine15To8 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  unsigned short temp;
  uint8* pDest = (uint8*)pDst;
...
void nglCopyLine15To15 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  if (Invert)
  {
    int32 i;
...
void nglCopyLine15To16 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  uint8 r,g,b;
  int16 temp;
...
void nglCopyLine15To24 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pDest = (uint8*)pDst;
...
void nglCopyLine15To32 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pDest = (uint8*)pDst;
...
/// From 16 BPP
void nglCopyLine16To8 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  uint16 temp;
  uint8* pDest = (uint8*)pDst;
...
void nglCopyLine16To15 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  uint8 r,g,b;
  int16 temp;
...
void nglCopyLine16To16 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  if (Invert)
  {
    int32 i;
...
void nglCopyLine16To24 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pDest = (uint8*)pDst;
...
void nglCopyLine16To32 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pDest = (uint8*)pDst;
...
/// From 24 BPP
void nglCopyLine24To8 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  char r,g,b;
  int32 i;
  uint8* pSource = (uint8*) pSrc;
...
void nglCopyLine24To15 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  int16 temp;
  uint8* pSource = (uint8*)pSrc;
...
void nglCopyLine24To16 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pSource = (uint8*)pSrc;
...
void nglCopyLine24To24 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  if (Invert)
  {
    int32 i;
...
void nglCopyLine24To32 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  uint8* pSource = (uint8*) pSrc;
  if (Invert)
...
/// From 32 BPP
void nglCopyLine32To8 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  uint8* pSource = (uint8*) pSrc;
  if (Invert)
...
void nglCopyLine32To15 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  int16 temp;
  uint8* pSource = (uint8*)pSrc;
...
void nglCopyLine32To16 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{
  int32 i;
  int16 temp;
  uint8* pSource = (uint8*)pSrc;
...
void nglCopyLine32To24 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  int32 i;
  uint8* pSource = (uint8*) pSrc;
  if (Invert)
...
void nglCopyLine32To32 (void* pDst, void* pSrc, int32 PixelCount, bool Invert)
{                                          
  if (Invert)
  {
    int32 i;
...
/// Stubber:
nglCopyLineFn nglGetCopyLineFn (int32 DstBPP, int32 SrcBPP)
{
  switch (SrcBPP)
  {
  case 8:
