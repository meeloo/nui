...
#ifndef KIWI_NO_EXCEPTIONS
#define KIWI_ERROR_RETURN_TYPE void
#define KIWI_ERROR_RETURN
#define KIWI_RETURN_OK return kiwi::NoError;
#define KIWI_THROW_(X) throw X();
#define KIWI_THROW(X,Y) throw X(Y);
...
#define KIWI_THROWS
#define KIWI_ERROR_RETURN_TYPE kiwi::ErrorType
#define KIWI_ERROR_RETURN return
#define KIWI_RETURN_OK { return kiwi::NoError; }
#define KIWI_THROW_(X) { return X; }
#define KIWI_THROW(X,Y) { return X; }
#endif
