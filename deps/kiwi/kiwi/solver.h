...
public:
	...
	*/
	...
	{
		KIWI_ERROR_RETURN m_impl.addEditVariable( variable, strength );
	}
	...
	*/
	...
	{
		KIWI_ERROR_RETURN m_impl.removeEditVariable( variable );
	}
	...
	*/
	...
	{
		KIWI_ERROR_RETURN m_impl.suggestValue( variable, value );
	}
